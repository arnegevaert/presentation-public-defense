...
from util import paragraph, example_function_1, linreg_univariate, linreg_multivariate
from sklearn.metrics import root_mean_squared_error

config.background_color = "#262626ff"

def make_toc_slide(slide, chapter):
    contents_title = Text(
        "Contents", color=BLACK, font_size=32
    ).to_corner(UL)
    contents = paragraph(
        f"1. Introduction",
